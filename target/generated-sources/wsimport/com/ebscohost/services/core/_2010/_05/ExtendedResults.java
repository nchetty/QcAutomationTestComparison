...
/**
 * <p>Java class for ExtendedResults complex type.
 * 
 ...
 *         &lt;element name="Categories" type="{http://www.ebscohost.com/services/core/2010/05}ArrayOfExtendedResultCategory" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ExtendedResults", propOrder = {
    "status",
    "categories"
})
public class ExtendedResults {

    @XmlElement(name = "Status", required = true)
    @XmlSchemaType(name = "string")
    protected SearchProgressStatus status;
    @XmlElement(name = "Categories", nillable = true)
    protected ArrayOfExtendedResultCategory categories;
     ...
     * @return
     *     possible object is
     *     {@link ArrayOfExtendedResultCategory }
     *     
     */
    public ArrayOfExtendedResultCategory getCategories() {
        return categories;
    }
     ...
     *     
     */
    public void setCategories(ArrayOfExtendedResultCategory value) {
